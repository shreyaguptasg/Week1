...
public class ShortestTallestPlayer {
   ...
   public static int sumOfElements(int [] heights){
	...
	public static int tallestHeight (int [] heights){
		...
		for(int i=0; i<11; i++){
			tallest = Math.min(tallest, heights[i]);
		}
		return tallest;	
	}
  ...
  public static void main(String[] args) {
	...
	int mean = meanOfElements(sum, 11);
	...
	System.out.println("shortest player  height is " + shortest);
	System.out.println("tallest player height is " + tallest);
